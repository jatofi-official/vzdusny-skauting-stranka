...
<section class="about-section">
    <div class="about-grid">
        ...
        <div style="background: var(--bg-light); padding: 40px; border-radius: 16px;">
            ...
            <p>Ak ťa baví technika, drony, vesmír alebo lettectvo a v skautingu si nikdy nebol, toto je tvoja brána dnu. Spájame technológie s partiou a skautskými hodnotami. Zameriavame sa hlavne na mladých v skautskom a rangerskom veku (tj. 13-17), pre mladšie deti zatiaľ žiaľ nemáme kapacitu.</p>
